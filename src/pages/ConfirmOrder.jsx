...
function ConfirmOrder() {
  ...
  // ✅ Move this first so memo and selector can use it
  ...
  // ✅ Memoize the shipping address
  // const memoizedAddress = useMemo(() => shippingAddress, [shippingAddress]);

  // ✅ Compute totals only after shippingAddress exists
  // const total = useSelector((state) =>
  //   shippingAddress ? selectCartTotals(state, memoizedAddress) : {
  //     subTotal: 0,
  //     tax: 0,
  //     shippingFee: 0,
  //     total: 0,
  ...
  const total = useSelector((state) =>
  selectCartTotals(state, shippingAddress.state || "")
);
  ...
  if (!shippingAddress || !shippingAddress.fullName) {
    return <p>No shipping address found. Please go back and enter details.</p>;
  }
        ...
        {showBankDetails && (
          <div className="mt-4 bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-2">
              ...
              <FaEnvelope />{" "}
              <a
                href="mailto:mariseducreativeservicesandmore@gmail.com"
                className="text-blue-600 underline"
              >
                mariseducreativeservicesandmore@gmail.com
              </a>
              <br />
              <span>  <FaWhatsapp />         <a
...
//   const { user } = useSelector((state) => state.login);
// //   const total = useSelector((state) =>
// //   selectCartTotals(state, { state: shippingAddress.state })
// // );
// // const total = useSelector((state) =>
// //   selectCartTotals(state, shippingAddress)
// // );
//  const [shippingAddress, setShippingAddress] = useState({
//     fullName: "",
//     address: "",
...
// const memoizedAddress = useMemo(() => shippingAddress, [shippingAddress]);
//   const total = useSelector((state) => selectCartTotals(state, memoizedAddress));
